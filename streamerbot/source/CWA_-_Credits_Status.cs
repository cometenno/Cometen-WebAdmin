...
public class CPHInline
{
    ...
    {
        EnsureDefaults();
        BroadcastCreditsSettings("status");
        return true;
    }

    private void EnsureDefaults()
    {
        SetIfMissing("CometenCredits_TopTitle", "END OF STREAM CREDITS");
        SetIfMissing("CometenCredits_TopText", "Thank you for hanging out in the Cometen universe");
        SetIfMissing("CometenCredits_BottomTitle", "SEE YOU NEXT STREAM!");
        SetIfMissing("CometenCredits_BottomText", "Twitch: <TWITCH_CHANNEL> - X: <X_HANDLE> - YouTube: <YOUTUBE_HANDLE>");

        SetIfMissing("CometenCredits_ColorGold", "#f0a900");
        SetIfMissing("CometenCredits_ColorGoldLight", "#ffd56a");
        SetIfMissing("CometenCredits_ColorText", "#f5e7bd");
        SetIfMissing("CometenCredits_PanelBg", "rgba(0,0,0,0.52)");

        SetIfMissing("CometenCredits_TitleSize", "90");
        SetIfMissing("CometenCredits_TopTextSize", "28");
        SetIfMissing("CometenCredits_SectionTitleSize", "46");
        SetIfMissing("CometenCredits_NameSize", "38");
        SetIfMissing("CometenCredits_SmallNameSize", "30");
        SetIfMissing("CometenCredits_BottomTitleSize", "52");
        SetIfMissing("CometenCredits_BottomTextSize", "26");

        SetIfMissing("CometenCredits_ScrollSpeed", "120");
        SetIfMissing("CometenCredits_FrameLeft", "250");
        SetIfMissing("CometenCredits_FrameTop", "70");
        SetIfMissing("CometenCredits_FrameWidth", "1420");
        SetIfMissing("CometenCredits_FrameHeight", "940");
        SetIfMissing("CometenCredits_ViewportLeft", "300");
        SetIfMissing("CometenCredits_ViewportWidth", "1320");
        SetIfMissing("CometenCredits_SectionGap", "74");
    }
    ...
    private void BroadcastCreditsSettings(string action)
    {
        ...
        CPH.LogInfo("[CWA Credits] Settings broadcast: " + json);
    }
}
