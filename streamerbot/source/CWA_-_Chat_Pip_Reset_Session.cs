...
public class CPHInline
{
    public bool Execute()
    {
        ...
        CPH.SetGlobalVar("CometenChatPip_LastReason", "Session reset from WebAdmin", true);
        ...
        BroadcastSettings();
        CPH.LogInfo("[Chat Pip] Runtime chatter session reset from WebAdmin.");
        return true;
    }
    ...
    private void BroadcastSettings()
    {
        ...
        string json = JsonConvert.SerializeObject(new
        {
            ...
            lastUser = "",
            lastReason = "Session reset from WebAdmin",
